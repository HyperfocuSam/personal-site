...
我在 6 個國家、70+ 機構訓練過 10,000+ 專業人士。這個模式見得太多。我自己有另一組數字：一次性工作坊之後，大約只有 4% 參加者能維持有意義的 AI 使用。4% 留住，96% 在兩星期內縮回舊 workflow。9% 啟用率和我的 4% 留存率，量度的不是同一樣東西——前者是有沒有打開過，後者是有沒有用下去——但兩組數字指向同一個問題：買 AI 和用 AI 之間的落差，不是技術落差，是人的落差。為甚麼培訓留不住人，我在[另一篇](/blog/why-ai-training-doesnt-stick)拆解過。
