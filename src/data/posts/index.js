...
const posts = [
  ...
  },
  {
    ...
    featured: false,
    linkedPost: 'microsoft-copilot-training-hong-kong-tc',
  },
  {
    slug: 'microsoft-copilot-training-hong-kong-tc',
    title: '香港企業買 Copilot 培訓之前：先數清楚有幾多個 licence',
    date: '2026-03-15',
    excerpt: '公司已經在付 Microsoft 365 的錢，就以為自己有 Copilot。先數 licence，再數參加人數——然後把培訓落在 Copilot 真正值回那個 seat 的四個 app 上。',
    tags: ['ai-adoption', 'enterprise', 'ai-tools'],
    type: 'methodology',
    language: 'zh-Hant',
    image: '/images/blog/microsoft-copilot-training-hk-cover.webp',
    featured: false,
    linkedPost: 'microsoft-copilot-training-hong-kong',
  },
  {
  ...
  },
  {
    ...
    featured: false,
    linkedPost: 'hk-2026-budget-ai-training-tc',
  },
  {
    slug: 'hk-2026-budget-ai-training-tc',
    title: '2026 年預算案那 HK$5,000 萬 AI 培訓撥款，對你公司實際上代表甚麼',
    date: '2026-03-14',
    excerpt: '2026-27 年度預算案撥出 HK$5,000 萬做 AI 培訓。這筆錢實際上是甚麼、漏了甚麼，以及在沒有政府資助的情況下你應該怎樣開始。',
    tags: ['ai-adoption', 'enterprise'],
    type: 'reflection',
    language: 'zh-Hant',
    image: '/images/blog/hk-budget-ai-training-cover.webp',
    featured: false,
    linkedPost: 'hk-2026-budget-ai-training',
  },
  {
  ...
  },
  {
    ...
    featured: false,
    linkedPost: 'how-to-design-ai-pioneer-program-tc',
  },
  {
    slug: 'how-to-design-ai-pioneer-program-tc',
    title: '六節的 AI Pioneer Program，我是怎樣設計出來的',
    date: '2026-03-04',
    excerpt: '我為一間香港食品製造商的 19 位 HR 同事設計了一個六節、只用 Copilot 的 AI program——以及為甚麼第二個部門在第一個部門完成之前就已經落了 order。',
    tags: ['enterprise', 'ai-adoption'],
    type: 'case-study',
    language: 'zh-Hant',
    image: '/images/blog/pioneer-program-cover.webp',
    featured: false,
    linkedPost: 'how-to-design-ai-pioneer-program',
  },
  {
  ...
  },
  {
    ...
    featured: false,
    linkedPost: 'why-i-teach-copilot-not-chatgpt-tc',
  },
  {
    slug: 'why-i-teach-copilot-not-chatgpt-tc',
    title: '為甚麼企業工作坊我教 Copilot，不教 ChatGPT',
    date: '2025-12-30',
    excerpt: '大部分 AI trainer 第一日就開 ChatGPT。我不會。企業的房間我由 Copilot 起手，而這個選擇改變了採用之後怎樣發展。',
    tags: ['ai-adoption', 'enterprise'],
    type: 'methodology',
    language: 'zh-Hant',
    image: '/images/blog/copilot-not-chatgpt-cover.webp',
    featured: false,
    linkedPost: 'why-i-teach-copilot-not-chatgpt',
  },
  {
