...
const posts = [
  ...
  },
  {
    ...
    title: 'Claude Code 完全攻略：完整藍圖 — 我真正嘅系統',
    date: '2026-03-23',
    excerpt: '我將成個 Claude Code 系統公開晒。CLAUDE.md、skills、agents、hooks、cron、memory — 每一層點接駁，每一個決定背後嘅原因。',
    tags: ['claude-code', 'system-design', 'ai-architecture', 'personal-productivity', 'adhd'],
    type: 'case-study',
    image: '/images/blog/claude-code-mastery-part-5-cover.png',
    language: 'zh-Hant',
  ...
  },
  {
    ...
    title: 'Claude Code 完全攻略：Agent 團隊同自動化 — 你嘅 AI 工作團隊',
    date: '2026-03-21',
    excerpt: '我有 9 個 AI agent 跑緊 7 個 cron job。每個禮拜一 blog 自己出文。呢篇講成個 agent team architecture。',
    tags: ['claude-code', 'ai-agents', 'automation', 'multi-agent', 'cron'],
    type: 'methodology',
    image: '/images/blog/claude-code-mastery-part-4-cover.png',
    language: 'zh-Hant',
  ...
  },
  {
    ...
    title: 'Claude Code 完全攻略：Hooks 同安全機制 — 點樣令 AI 安全做嘢',
    date: '2026-03-20',
    excerpt: '有一次 Claude Code 差啲 send 錯 email 俾錯嘅人。嗰日之後我起咗一套 hooks 系統。PreToolUse、PostToolUse、Stop hook — 全部跑喺 FastAPI server。',
    tags: ['claude-code', 'ai-safety', 'hooks', 'automation', 'guardrails'],
    type: 'methodology',
    image: '/images/blog/claude-code-mastery-part-3-cover.png',
    language: 'zh-Hant',
  ...
  },
  {
    ...
    title: 'Claude Code 完全攻略：Skills 同 Memory — 教 AI 識記嘢',
    date: '2026-03-19',
    excerpt: 'AI 最大嘅問題係佢唔記得。我喺 Claude Code 入面起咗四層 memory，加 40 個 skills 用 progressive disclosure。呢篇講晒成個架構。',
    tags: ['claude-code', 'ai-memory', 'skills', 'productivity-system'],
    type: 'methodology',
    image: '/images/blog/claude-code-mastery-part-2-cover.png',
    language: 'zh-Hant',
