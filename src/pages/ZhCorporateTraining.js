...
const faqItems = [
  {
    q: '香港企業 AI 培訓的收費是多少？',
    a: '每個合作都在免費 30 分鐘初步諮詢後正式報價——'
      + '費用視乎人數、語言及後續跟進深度。'
      + '半日認知工作坊、全日生產力培訓、多週 Pioneer'
      + ' Program 均可選擇。'
      + '部分課程可符合 NITTP 資助資格：1:1 配對，'
      + '每間企業每個財政年度上限 25 萬港元。'
      + '至於大部分同業仍在提的「科技券」（TVP），'
  ...
  },
  {
    ...
    a: '有。透過 Adaptig，我有一個遍及北美、拉丁美洲、歐洲和'
